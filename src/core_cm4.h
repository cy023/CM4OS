 ...
 * @file   core_cm4.h
 * @author cy023
 * @brief  ARM Cortex-M4 peripherals
 * @ref    Cortex-M4 Devices Generic User Guide
...
#define ID_AFR0             (*(volatile uint32_t *)0xE000ED4C)
